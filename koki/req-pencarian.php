...
if($db->connect_errno==0){
	...
	if (ISSET($_POST['submit'])){
		...
		$sql="SELECT r.id_req_bbaku, b.id_bbaku, b.n_bbaku, r.jumlah FROM req_bbaku r JOIN bahan_baku b ON b.id_bbaku = r.id_bbaku
                 WHERE b.n_bbaku like '%$cari%' ORDER BY b.n_bbaku";
		$res=$db->query($sql);
