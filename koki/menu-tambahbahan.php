            ...
            <div class="card mt-3">
                <div class="card-header">
                    <ul class="nav nav-pills card-header-pills">
					    <li class="nav-item">
					       	<a class="nav-link" href="#" tabindex="-1" aria-disabled="true">Koki > List Menu > Tambah Bahan Baku</a>
					    </li>
					  	...
					  	<thead class="thead-light">
							...
							foreach($data as $barisdata){ // telusuri satu per satu
								...
								<tr>
									...
									<td>
									<a href="menu-simpanbahan.php?id_bbaku=<?php echo $barisdata["id_bbaku"];?>&id_menu=<?php echo $id_menu;?>"><button class="btn btn-success btn-sm"><i class="fas fa-plus mr-2"></i>Tambah</button></a>  </td>
									</tr>
									<?php
						            $nomor++;
								    }
