...
<!DOCTYPE html>
<html><head><title>Edit Data Pegawai</title></head>
...
<div class="container-fluid">
    ...
    <div class="row">
            ...
            <div class="card mt-3">
                <div class="card-header">
                	<ul class="nav nav-pills card-header-pills">
	                	<li class="nav-item">
						    <a class="nav-link" href="#" tabindex="-1" aria-disabled="true">Pemilik > Pegawai > Edit Data Pegawai</a>
						</li>
                ...
                <div class="card-body">
                	<div class="box">
						<form method="post" name="frm" action="update_pegawai.php" onsubmit="return validasi()">
							...
							<div class="form-group">
							    ...
							    <input type="text" name="n_pegawai" class="form-control" id="exampleFormControlInput1" value="<?php echo $datapegawai["n_pegawai"];?>">
							</div>
							<div class="form-group">
							    ...
							    <select class="form-control" id="exampleFormControlSelect1" name="jabatan">
							      	<?php
										...
										if ($jabatan== "customer service") echo "<option value='customer service' selected>Customer Service</option>";
										else echo "<option value='customer service'>Customer Service</option>";
										if ($jabatan == "koki") echo "<option value='koki' selected>Koki</option>";
										else echo "<option value='koki'>Koki</option>";
										if ($jabatan== "pantry") echo "<option value='pantry' selected>Pantry</option>";
										else echo "<option value='pantry'>Pantry</option>";
										if ($jabatan== "pelayan") echo "<option value='pelayan' selected>Pelayan</option>";
										else echo "<option value='pelayan'>Pelayan</option>";
										if ($jabatan== "kasir") echo "<option value='kasir' selected>Kasir</option>";
										else echo "<option value='kasir'>Kasir</option>";                      
									?>
							    </select>
							</div>
							<div class="form-group">
							    <label for="exampleFormControlInput1">Username</label>
							    <input type="text" name="username" class="form-control" id="exampleFormControlInput1" value="<?php echo $datapegawai["username"];?>">
							</div>
							<div class="form-group">
							    <label for="exampleFormControlInput1">Password</label>
							    <input type="text" name="password" class="form-control" id="exampleFormControlInput1" value="<?php echo $datapegawai["password"];?>">
							</div>
							<button type="submit" name="TblUpdate" class="btn btn-success mr-2"><i class="fas fa-user-edit"></i>Simpan</button>
		...
		echo "Pegawai dengan NIP : $id_pegawai tidak ada. Pengeditan dibatalkan";
?>
<?php
}
else
