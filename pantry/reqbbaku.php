...
?>
<!DOCTYPE html>
<html><head><title>View Data Req Bahan Baku</title></head>
            ...
            <div class="card mt-3">
                <div class="card-header">
                    <ul class="nav nav-pills card-header-pills">
					      	<li class="nav-item">
					        	<a class="nav-link" href="#" tabindex="-1" aria-disabled="true">Pantry > List req Bahan Baku</a>
					      	</li>
                ...
                <div class="card-body">
                	<a href="pdf.php" class="btn btn-secondary btn-sm mb-3"><i class="fas fa-cloud-download-alt mr-2"></i>Download Data Req Bahan Baku</a>
